...
public class Main {
    public static void main(String[] args) {
        ...
        List<Integer> pares = numeros.stream()
                .filter(n -> n % 2 == 0)  // Mantiene solo números pares
                .collect(Collectors.toList());  // Convierte stream a Lista
        ...
        List<Integer> cuadrados = numeros.stream()
                .map(n -> n * n)  // Transforma cada número a su cuadrado
         ...
         */
        productos.stream()
                .filter(p -> p.getPrecio().compareTo(new BigDecimal("100")) > 0)  // Solo productos > $100
                .forEach(System.out::println);  // Imprime cada producto filtrado
         ...
         *    - Producto::getPrecio es una referencia de método que extrae el precio de cada producto
         ...
         */
        // Stream<String> de nombres
        // Para cada nombre, obtener sus caracteres
         ...
         */
        // Convierte a DoubleStream
        // Calcula todas las estadísticas de una vez

//        // EJERCICIOS PARA RESOLVER
//        System.out.println("\n\n=== EJERCICIOS PARA RESOLVER ===");
//        Ejercicios.resolverEjercicios(productos, empleados, numeros);
